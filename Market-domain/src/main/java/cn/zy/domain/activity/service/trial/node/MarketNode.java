...
import cn.zy.domain.activity.service.discount.IDiscountCalculateService;
...
import cn.zy.domain.activity.service.trial.thread.QueryGroupBuyActivityDiscountVOThreadTask;
import cn.zy.domain.activity.service.trial.thread.QuerySkuVOFromDBThreadTask;
import cn.zy.types.design.framework.tree.StrategyHandler;
import cn.zy.types.enums.ResponseCode;
import cn.zy.types.exception.AppException;
...
public class MarketNode extends AbstractGroupBuyMarketSupport<MarketProductEntity, DefaultActivityStrategyFactory.DynamicContext, TrialBalanceEntity> {
    ...
    protected void multiThread(MarketProductEntity requestParameter, DefaultActivityStrategyFactory.DynamicContext dynamicContext) throws ExecutionException, InterruptedException, TimeoutException {
        // 异步查询活动配置
        // tips:创建任务（Callable）→ 包装成 FutureTask → 丢进线程池执行。
